...
class IntranetOportunidadVisitasModel(BASE):
    ...
    nit_ejecutivo = Column(String(50))
    ejecutivo_nombre = Column(String(300))
    ...
    def __init__(self, data: dict):
        ...
        self.nit_ejecutivo = data.get("nit_ejecutivo")
        self.ejecutivo_nombre = data.get("ejecutivo_nombre")
